                ...
                <div className="grid grid-cols-1 gap-4 auto-rows-fr md:grid-cols-[2fr,3fr] lg:grid-cols-[500px,1fr] xl:grid-cols-[615px,1fr]">
                    <div className="relative bg-[#FAFAFA] rounded-3xl p-6 overflow-hidden xl:p-10">
                        <div className="relative z-10 h-full flex flex-col items-start">
                            ...
                            <a
                                href="/contact"
                                className="flex px-[18px] py-[14px] rounded-[32px] border border-appGray-200 text-xs leading-none tracking-[-0.41px] font-medium text-appGray-500 uppercase mb-14 transition-all duration-300 hover:bg-appText hover:text-white hover:border-appText lg:px-6 lg:py-4 lg:text-sm lg:leading-none"
                            >
                                Iniciar Proyecto
                            </a>
                    ...
                    <div className="relative rounded-3xl overflow-hidden aspect-square md:aspect-auto xl:aspect-[1.3]">
                        <img
                            src={image.src}
                            alt={image.alt}
                            className="size-full object-cover w-full h-full rounded-3xl mx-auto"
                        />
                    </div>
                </div>
            </div>
