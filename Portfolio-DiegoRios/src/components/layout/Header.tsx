        ...
        <header className="relative z-50">
            ...
            <div 
                className={classNames(
                    'fixed inset-0 w-screen h-screen md:hidden z-[55] transition-all duration-300',
                    {
            ...
            >
                ...
                <div 
                    ...
                    style={{ backgroundImage: 'url(/meshGradient2.jpg)' }}
                />
                {/* Dark mode background image */}
                <div 
                    className="absolute inset-0 bg-cover bg-center bg-no-repeat hidden dark:block"
                    style={{ backgroundImage: 'url(/meshGradient-modo-oscuro.jpg)' }}
                />
            </div>
            ...
            >
                ...
                <div className="container pt-6 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                        <ThemeToggle variant="mobile" className="text-content dark:text-white relative z-[100]" />
                        <button
                            type="button"
                            className="w-11 h-11 flex items-center justify-center rounded-full hover:bg-black/10 dark:hover:bg-white/10 transition-colors duration-200 relative z-[100]"
            ...
            <div className="flex-1 min-h-[60px]" />
                ...
                <div className="container pb-10">
                    ...
                    <a 
                        ...
                        download
                        className="inline-flex items-center gap-2 px-6 py-3 border border-content/30 dark:border-white/30 rounded-full text-sm font-medium uppercase tracking-widest text-content/90 dark:text-white/90 hover:bg-content hover:text-white dark:hover:bg-white dark:hover:text-[#0a0a0a] transition-all duration-300"
                    >
                        Descargar CV
                    ...
                    <div className="flex items-center gap-2 mt-6">
                        ...
                        <span className="text-sm text-content-muted/70 dark:text-white/50">Disponible para proyectos</span>
                    </div>

                    {/* Social Links */}
                    <div className="flex items-center gap-6 mt-8">
                        <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="text-content-muted/60 dark:text-white/40 hover:text-content dark:hover:text-white transition-colors duration-200">
                            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                                <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
                            </svg>
                        </a>
                        <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="text-content-muted/60 dark:text-white/40 hover:text-content dark:hover:text-white transition-colors duration-200">
                            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="text-content-muted/60 dark:text-white/40 hover:text-content dark:hover:text-white transition-colors duration-200">
                            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
